 ...
 * </ol>
 */
public class YzyScaleVideoView extends TextureView
    ...
    public YzyScaleVideoView(Context context) {
        super(context);
        initVideoView();
    }

    public YzyScaleVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initVideoView();
    }

    public YzyScaleVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(YzyScaleVideoView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(YzyScaleVideoView.class.getName());
    }
